...
- [ ] **spacing-typography-vars** — `--spacing-typography-vertical` (hgroup) and
  `--spacing-typography-horizontal` (nav) are referenced but never defined.
  Define in the sizing theme or repoint to `--spacing-block-*`. Ref §3.2.
